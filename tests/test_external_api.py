...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "Сумма в рублях: 10000.0",
        )  # Результат будет 10000 RUB при курсе 100
    ],
)
...
def test_convert(mock_request, data_json, expected_result):
    ...
    mock_response.json.return_value = {"result": 10000.0}  # Имитируем ответ json
